...
function JQueryAccessibleSlider_init() {
    ...
    if ( !is_admin() && is_active_widget('widget_JQueryAccessibleSlider') ) {
        wp_register_style('jquery.ui.all', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleSlider/lib/jquery-ui/themes/base/jquery.ui.all.css'));
        wp_enqueue_style('jquery.ui.all');

        wp_deregister_script('jquery');

        // add your own script
        wp_register_script('jquery-1.4.2', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleSlider/lib/jquery-ui/jquery-1.4.2.js'));
        wp_enqueue_script('jquery-1.4.2');

        wp_register_script('jquery.ui.core', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleSlider/lib/jquery-ui/ui/jquery.ui.core.js'));
        wp_enqueue_script('jquery.ui.core');

        wp_register_script('jquery.ui.widget', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleSlider/lib/jquery-ui/ui/jquery.ui.widget.js'));
        wp_enqueue_script('jquery.ui.widget');

        wp_register_script('jquery.ui.mouse', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleSlider/lib/jquery-ui/ui/jquery.ui.mouse.js'));
        wp_enqueue_script('jquery.ui.mouse');

        wp_register_script('jquery.ui.slider', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleSlider/lib/jquery-ui/ui/jquery.ui.slider.js'));
        wp_enqueue_script('jquery.ui.slider');

        wp_register_script('jquery.ui.accordion', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleSlider/lib/jquery-ui/ui/jquery.ui.accordion.js'));
        wp_enqueue_script('jquery.ui.accordion');

        wp_register_style('demos', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleSlider/lib/jquery-ui/demos.css'));
        wp_enqueue_style('demos');

        wp_register_script('JQueryAccessibleSlider', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleSlider/lib/JQueryAccessibleSlider.js'));
        wp_enqueue_script('JQueryAccessibleSlider');

        wp_register_style('JQueryAccessibleSlider_css', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleSlider/lib/JQueryAccessibleSlider.css'));
